...
Opening a pull request will trigger a[workflow](../.github/workflows/mz-mlstacks-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://e2-demo-emea.cloud.databricks.com#mlflow/models/staging-mz-mlstacks-model)
* [Prod workspace registered model](https://e2-demo-emea.cloud.databricks.com#mlflow/models/prod-mz-mlstacks-model)
