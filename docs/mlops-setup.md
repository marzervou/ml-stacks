...
[ML Config](../mz_mlstacks/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore mz_mlstacks/databricks-resources/README.md
...
Follow the instructions in [mz-mlstacks/databricks-resources/README.md](../mz_mlstacks/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../mz_mlstacks/databricks-resources/README.md)  to propose, test, and deploy
