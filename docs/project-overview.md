...
```
mz-mlstacks         <- Root directory. Both monorepo and polyrepo are supported.
│
├── mz_mlstacks       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
